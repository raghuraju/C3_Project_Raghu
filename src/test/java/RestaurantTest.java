...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        Restaurant restaurant = new Restaurant("abc", "Delhi", LocalTime.of(10, 0), LocalTime.of(12, 0));
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        Restaurant restaurant = new Restaurant("xyz", "Visakhapatnam", LocalTime.of(10, 0), LocalTime.of(12, 0));
        Restaurant restaurantSpy = Mockito.spy(restaurant);
